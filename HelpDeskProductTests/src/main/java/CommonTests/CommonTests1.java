...
public static String FullName = "Reese Harold";
...
public void loginasAdmin() {
	...
	{	
		...
		hploginpage.navigateToProfileHappyFoxHomePageURL(AdminPortalURL);
		hploginpage.login(username,password);
		System.out.println("username, password are entered and login button is clicked");
